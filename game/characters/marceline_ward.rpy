...
image marceline_ward normal             = "characters/marceline_ward/marceline_ward_normal.png"
image marceline_ward normal_blush       = "characters/marceline_ward/marceline_ward_normal_blush.png"
image marceline_ward happy              = "characters/marceline_ward/marceline_ward_happy.png"
image marceline_ward surprised          = "characters/marceline_ward/marceline_ward_surprised.png"
image marceline_ward surprised_blush    = "characters/marceline_ward/marceline_ward_surprised_blush.png"

image marceline_ward 1 = "characters/marceline_ward/marceline_ward_1.png"
image marceline_ward 2 = "characters/marceline_ward/marceline_ward_2.png"
image marceline_ward 3 = "characters/marceline_ward/marceline_ward_3.png"

image marceline_ward 5 = "characters/marceline_ward/marceline_ward_5.png"

image marceline_ward 7 = "characters/marceline_ward/marceline_ward_7.png"
image marceline_ward 8 = "characters/marceline_ward/marceline_ward_8.png"

image marceline_ward_class_happy        = "characters/marceline_ward/events/marceline_ward_class_happy.jpg"
image marceline_ward_class_horny        = "characters/marceline_ward/events/marceline_ward_class_horny.jpg"
...
init:
    ...
    $ event("marceline_ward_class1", "act == 'class'", event.once(), event.choose_one('class'), event.depends("marceline_ward_hallway"))
    $ event("marceline_ward_school_grounds", "act == 'school_grounds'", event.once(), event.choose_one('school_grounds'), event.depends("marceline_ward_class1"))
    $ event("marceline_ward_gym", "act == 'gym'", event.once(), event.choose_one('gym'), event.depends("marceline_ward_school_grounds"))
    $ event("marceline_ward_class2", "act == 'class'", event.once(), event.choose_one('class'), event.depends("marceline_ward_gym"))
    $ event("marceline_ward_class3", "act == 'class'", event.once(), event.choose_one('class'), event.depends("marceline_ward_class2"))
    #$ event("marceline_ward_school_grounds2", "act == 'school_grounds'", event.once(), event.choose_one('school_grounds'), event.depends("marceline_ward_school_grounds", "adaki_school_grounds"), event.only(), priority=1)
    $ event("marceline_ward_school_grounds2", "act == 'school_grounds'", event.once(), event.depends("marceline_ward_school_grounds", "adaki_school_grounds"), event.only(), priority=1)
    
    #Main story events:
    #$ event("marceline_ward_regarding_adaki", "act == 'school_grounds'", event.once(), event.choose_one('school_grounds'), event.depends("marceline_ward_school_grounds", "adaki_school_grounds"), event.only(), priority=1)
    $ event("marceline_ward_regarding_adaki", "act == 'school_grounds'", event.once(), event.depends("marceline_ward_school_grounds", "adaki_school_grounds"), event.only(), priority=1)
