...
init python:
    ...
    jack_drake_nickname = ''
    jack_drake_points = 0
    jack_drake_return_date = 0

define jack_drake = Character('Jack Drake', color="#878083")

# Sprites
image jack_drake smile                  = "characters/jack_drake/jack_drake_smile.png"
image jack_drake normal                 = "characters/jack_drake/jack_drake_normal.png"
image jack_drake normal_blink           = "characters/jack_drake/jack_drake_normal_blink.png"
image jack_drake surprised              = "characters/jack_drake/jack_drake_surprised.png"
image jack_drake surprised_blink        = "characters/jack_drake/jack_drake_surprised_blink.png"
image jack_drake sweat                  = "characters/jack_drake/jack_drake_sweat.png"
image jack_drake facepalm               = "characters/jack_drake/jack_drake_facepalm.png"
image jack_drake facepalm_sad           = "characters/jack_drake/jack_drake_facepalm_sad.png"

init:
    #First we have all the povGender == 'male' interactions:
    $ event("office_introduction_male", "act == 'office' and povGender == 'male'", event.once(), event.only(), priority=1)
    $ event("jack_drake_office", "act == 'office' and planning_day > 2 and hit_the_road_jack == False", event.choose_one('office'), event.depends("office_introduction_male"))
    ...
    $ event("office_where_is_jack", "act == 'office' and hit_the_road_jack == True", event.once(), event.only(), priority=1)
...
label jack_drake_office:
    ...
    if deviance > 95 and inhibition < 5 and academics > 95 and behavior > 95:
    ...
    elif deviance > 10 and inhibition < 75 and (uniform == sexy_uniform or uniform == nude_uniform):
        show jack_drake normal_blink
        ...
        jack_drake "Some kids actually have some brains and asks a shit load of stupid questions. Of-{i}fuckin'{/i}-course was the majority of Carl Jung's later work influenced by his experience of cocaine. Just read his letter to his wife!"
    elif academics > 35:
        show jack_drake facepalm
...
label office_where_is_jack:
    ...
    menu:
        "Yeah, I told him to hit the road.":
            ...
            susan_marina "..."
            show susan_marina angry
            susan_marina "He's one of the schools most prominent professors, boasting a dual Ph.D in cognitive neuropsychology and bioinformatics and don't foreget a Sc.D in physics!"
