...
label fla_classroom3:
    ...
    "It's always good to see students enjoying their lunch."
    return
...
label fla_classroom5:
    ...
    menu:
        "Enjoy the show":
            "While the girl doesn't seem to mind your stare, you're not quite sure the other students in the room share the sentiment."
            $ inhibition -=1
...
label fla_classroom6:
    ...
    "Looks like English class is going well. You spend a few minutes listening to the student reading from the textbook and try not to laugh when she stutters on 'counterquasiproantiunredemidisestablishmentarianism'"
    return
...
label fla_classroom8:
    ...
    "Some of your students are getting fed up with their rowdier classmates."
    return
...
label fla_classroom10:
    ...
    "Looks like today's biology class is focusing on the female reproductive system. It's great to see the female students helping out!"
    return
...
label fla_classroom12:
    ...
    "Your students know that proper motivation is key to any endeavor. This student agreed to have sex with anyone who got a perfect score on the last test."
    return
...
label fla_classroom13:
    ...
    menu:
        "Hand her some tissues":
            "She mumbles a thank you but it's clear from the way she avoids looking at you and deeply blushes that she's mortified to be seen like this."
            $ morale -=1
            $ deviance +=1
        ...
        "Pretend not to have seen her":
            ...
            "You're not sure the girl believes your words, but she at least seems grateful you made the attempt."
            $ morale +=1
            $ behavior -=1
    return
...
label fla_classroom15:
    ...
    "Teachers are no more immune to the rising tide of lust than your students. Fortunately, they do tend to be more discreet."
    return
...
label fla_classroom16:
    ...
    "It seems that tit fucking is becoming popular among the bustier students."
    return
...
label fla_classroom17:
    ...
    "From the looks of things, most of the other students are scandalized but turned on. However, letting them continue would be probably be bad for discipline, and could ruin the school's reputation."
    menu:
        "They need to learn this stuff. Enjoy the show":
            "You watch on with a benevolent smile as the cries of pleasure reach a fervent pitch. Soon, cum is pouring into the girl's pussy as she shudders with orgasm."
            if renpy.random.randint(1, 2) == 1:
                "As the sated lovers leave to get clean, the class bursts into amazed gossip. It takes forever to get them focused on the next lesson."
                $ behavior -=5
                $ inhibition -=3
                $ deviance +=3
            else:
                "As the two lovers leave to get clean, you can see quite a few students trying to hide the signs of their arousal. However, you also spot more than one clearly disgusted student."
                $ behavior -=5
                $ inhibition -=3
                $ deviance +=3
                $ reputation -=2
        ...
        "This must be stopped":
            ...
            pov "WHAT THE IN THE HELL DO YOU THINK YOU'RE DOING!?"
            boy "We were just..."
...
label fla_classroom18:
    ...
    "These days it's not too uncommon for you to enter a room and find an orgy going on."
    return

label fla_classroom19:

    scene bg fla_classroom19 with fade
    "The students always know which classrooms will be unused and available."
    return

label fla_classroom20:

    scene bg fla_classroom20 with fade
    "A scraping noise prompts you to peek into a classroom that should be empty this time of day. You see a faintly blushing girl lying nearly nude atop some desks. Looks like someone is a budding exhibitionist!"
    return

label fla_classroom21:

    scene bg fla_classroom21 with fade
    "This exhibitionist considers it her job to loosen up the more restrained students. While most of the class barely notices her antics any more, these boys can't take their eyes off her moist pussy."
    return
...
label fla_classroom24:
    ...
    "Quiet sounds of feminine moaning lead you to peek into an unused classroom. Looks like it's 'no boys allowed' to you."
    return

label fla_classroom25:

    scene bg fla_classroom25 with fade
    "Huh. That red-haired girl and that boy had both been after the same girl for weeks. Looks like they decided teaming up was the best way to catch her."
    return

label fla_classroom26:

    scene bg fla_classroom26 with fade
    "A careful peek into this classroom nets a great view of a silver haired beauty masturbating before going home."
    return
...
label fla_classroom28:
    ...
    "As you reach under a desk to retrieve a dropped pen you get quite the eyeful. She notices your gaze and simply smirks at you."
    menu:
        "Give an appreciative smile back":
            "You take a good second look before straightening up and handing her pen back."
            $ inhibition -=1
        "Give detention":
...
label fla_classroom29:
    ...
    "It's not that uncommon for you to peek into a classroom at the end of the day and spot someone using their desk to take the edge off."
    return
...
label fla_classroom31:
    ...
    "Some of your students are getting bored with simple handjobs and want to try something a little more difficult."
    return
...
label fla_classroom32:
    ...
    if uniform == 'nude_uniform':
        ...
        "Looks like Home Ec class has turned into another lesbian orgy. This might not happen if they wore something more than just aprons. Somehow, you can't bring yourself to scold them."
    return

label fla_classroom33:

    scene bg fla_classroom33 with fade
    "Funny, the heat doesn't seem that bad to you, but these girls are so desperate to cool down that they're baring their underwear right in front of you."
    return

label fla_classroom34:

    scene bg fla_classroom34 with fade
    "Your athletics program has paid off big time. This boy has managed to fuck every girl in his class multiple times without a break. You can't help but be impressed."
    return
...
label fla_classroom35:
    ...
    "Looks like Sex Ed classes have gotten to masturbation. You're glad to see your students diligently learning important skills!"
    return

label fla_classroom36:

    scene bg fla_classroom36 with fade
    "These two sisters just transferred into your school. A few of their classmates convinced them this was a school tradition."
    return
...
label fla_classroom37:
    ...
    girl1 "I wasn't too sure at first, but after a little while it didn't bother me at all!"
    girl2 "Yeah, there's something empowering about just baring everything!"
    pov "Glad to hear it."
    return
...
label fla_classroom38:
    ...
    "Hmm, maybe you were a bit hasty implementing the Nude Uniform policy. Most of these students seems very embarrassed."
    $ morale -=1
    return
...
label fla_classroom40:
    ...
    "It wasn't easy finding enough boys for the gangbang portion of Sex Ed, but you feel it's important for the girls to know how to deal with multiple partners."
    return
...
label fla_classroom42:
    ...
    "Looks like the remedial lesson on masturbation is going quite well. You're sure these girls will pass the make up test with little problem."
    return
...
label fla_classroom44:
    ...
    "Hmm, looks like you walked into the class during a cunnilingus test. Some of the girls blush as you watch, but judging by the way their pussies get even wetter, it's just making them more excited."
    return
