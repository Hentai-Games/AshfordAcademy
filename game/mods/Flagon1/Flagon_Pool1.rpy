...
label fla_pool4:
    ...
    "A group of students is cleaning the pool. Looks like they're having fun!"
    $ behavior +=1
    return
...
label fla_pool7:
    ...
    girl "Is it just me or are these school swimsuits too small?"
    return
...
label fla_pool8:
    ...
    if inhibition > 60:
        ...
        "The girl flashes you a naughty grin, winks, and pulls up her top."
        girl "How about now?"
        pov "Truly divine."
        $ deviance +=1
        $ inhibition -=1
...
label fla_pool10:
    ...
    "You're not sure what impresses you more, how long she can hold her breath or her ability to apply suction without swallowing water."
    $ athletics +=1
...
label fla_pool11:
    ...
    "Your students have now begun teaching each other more advanced lessons, like sex in the water."
    $ behavior +=2
    $ deviance +=1
    if renpy.random.randint(1, 3) == 1:
        $ deviance+= 5
...
label fla_pool13:
    ...
    "A surprised cry draws your attention. Looks like this students had a slight wardrobe malfunction."
    $ inhibition -=1
    return
...
label fla_pool16:
    ...
    "These two girls do this every day after swim class. They claim it helps to stretch their muscles after a hard workout."
    return
...
label fla_pool20:
    ...
    "You can feel your body responding to the kisses and caresses of the girls. You hold out as long as you can, but these girls are insatiable. After what feels like days of thrusting, licking and fingering, you eventually pass out in a pool of cum and sweat."
