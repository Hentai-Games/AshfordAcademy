...
label fla_bath6:
    ...
    "Some of your students have decided to show thier appreciation for all the hard work you've put into the school."
    "As soapy hands move over your body you can definatly say that it was worth the effort."
    $ deviance +=1
    $ inhibition -=1
    if renpy.random.randint(1, 3) ==1:
        $ deviance += 5
...
label fla_bath8:
    ...
    girl2 "*giggle* Of course! See for your self!"
...
label fla_bath10:
    ...
    "You walk into the girls bathroom only to spot one of your teachers. Who immediatly notices you."
    
    if inhibition > 70:
        scene bg fla_bath10_2
    
        teacher "What do you think your doing in here [povTitle][povLastName]!?"
        ...
        pov "I just wanted to talk to you about this weeks lesson plan quick."
        teacher "Of course! Could you help me scrub my back while we talk?"
        "You have an enjoyable conversation."
        $ inhibition -=1
    return
...
label fla_bath11:
    ...
    teacher "Oh nothing special. Plenty of milk. The occasional massage."
