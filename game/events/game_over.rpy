image game_over         = "images/splash/game_over.jpg"
image game_over_shot1   = "images/splash/game_over_shot1.jpg"
image game_over_shot2   = "images/splash/game_over_shot2.jpg"
image game_over_burn    = "images/splash/game_over_burn.jpg"

#Here is the game over conditions and events, including good endings.
define game_length = float('inf')
define length_options = [
{"text": "1 year",    "length": 365 * 1},
{"text": "3 years",   "length": 365 * 3},
{"text": "5 years",   "length": 365 * 5},
{"text": "10 years",  "length": 365 * 10},
{"text": "Unlimited", "length": float('inf')}
]

init:
    $ event("game_over_normal", "act == 'new_day' and total_days >= game_length", event.choose_one('new_day'),event.only(), priority=-100)
    $ event("game_over_fired",  "act == 'new_day' and reputation <= 0 and evil_points < 2", event.choose_one('new_day'),event.only(), priority=-100)
    $ event("game_over_shot",   "act == 'new_day' and reputation <= 0 and evil_points >= 2", event.choose_one('new_day'),event.only(), priority=-100)
    $ event("game_over_burn",   "act == 'new_day' and total_days > 90 and behavior <= 20 and renpy.random.random() > 0.85", event.choose_one('new_day'),event.only(), priority=-100)

# TODO: Add endings!
label game_over_normal:
    scene black
    "...\nYou slowly wake up and take your time to get dressed."
    scene game_over with fade
    pov "This is it huh?\nLast day as principal of [school_name]...\nI wonder what legacy I will leave behind..."
    "You have been principal of [school_name] for [total_days] and all your students will be rembered as..."
    # TODO: Keep on workin'!
    "Ash" "Actually I don't know, but this is a planned feature..."
    "Ash" "Good work and...\nGAME OVER."
    # TODO: Difficulity will unlock events!
...
label game_over_shot:
    ...
    scene game_over_shot1 with fade
    pov "Huh?"
    ...
    scene game_over_shot2 with vpunch
    "BANG!"
