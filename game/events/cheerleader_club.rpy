init:
    if persistent.mod_disable_original_events == False:
        $ event("cheerleader_club1", "act == 'club_rooms' and cheerleader_club > 0", event.choose_one('cheerleader_club'))
        $ event("cheerleader_club2", "act == 'club_rooms' and cheerleader_club > 0", event.choose_one('cheerleader_club'))
        $ event("cheerleader_club3", "act == 'club_rooms' and cheerleader_club > 0", event.choose_one('cheerleader_club'))

        #TODO: Actually add events!
        $ event("cheerleader_club4", "act == 'club_rooms' and cheerleader_club > 0", event.choose_one('cheerleader_club'))
        $ event("cheerleader_club5", "act == 'club_rooms' and cheerleader_club > 0", event.choose_one('cheerleader_club'))
        $ event("cheerleader_club6", "act == 'club_rooms' and cheerleader_club > 0", event.choose_one('cheerleader_club'), event.depends("cheerleader_club5"))
        $ event("cheerleader_club7", "act == 'club_rooms' and cheerleader_club > 0", event.choose_one('cheerleader_club'))
        $ event("cheerleader_club8", "act == 'club_rooms' and cheerleader_club > 0", event.choose_one('cheerleader_club'))

label cheerleader_club1:
    scene cheerleader_club1 with fade
...
label cheerleader_club2:
    scene cheerleader_club2 with fade
...
label cheerleader_club3:
    if reputation < 40:
        scene cheerleader_club3-1 with fade
...
label cheerleader_club4:
    scene cheerleader_club4-1 with fade
    "What's this?"
...
label cheerleader_club5:
    scene cheerleader_club5 with fade
...
label cheerleader_club6:
    scene cheerleader_club6 with fade
...
label cheerleader_club7:
    scene cheerleader_club7 with fade
    "girls" "Go Ashford! Go Ashford!"
    return


label cheerleader_club8:
    scene cheerleader_club8 with fade
    girl "*giggle* [povTitle] [povLastName], do you like my outfit?\nIt's not covering much, but I kinda like it!"
    pov "As long as you like it I'm happy."
    return
