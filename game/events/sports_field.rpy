init:
    if persistent.mod_disable_original_events == False:
        $ event("sports_field1", "act == 'sports_field' and deviance < 5 and athletics < 50", event.choose_one('sports_field'))
        $ event("sports_field2", "act == 'sports_field' and deviance < 5 and athletics < 25", event.choose_one('sports_field'))
        $ event("sports_field3", "act == 'sports_field' and deviance < 5 and athletics < 50", event.choose_one('sports_field'))
        $ event("sports_field4", "act == 'sports_field' and deviance >= 50 and inhibition <= 80", event.once(), event.choose_one('sports_field', 5))    #WD: Stop Dup Events# priority=20)
        $ event("sports_field5", "act == 'sports_field' and deviance >= 15 and inhibition <= 80", event.choose_one('sports_field'))                     #Ash: Sorry about that >.<
        $ event("sports_field6", "act == 'sports_field' and morale >= 10", event.choose_one('sports_field'))
        $ event("sports_field7", "act == 'sports_field' and deviance > 5 and athletics < 75", event.choose_one('sports_field'))
        $ event("sports_field8", "act == 'sports_field' and inhibition <= 95", event.choose_one('sports_field'))
        $ event("sports_field9", "act == 'sports_field' and deviance > 5", event.choose_one('sports_field'))
        $ event("sports_field10", "act == 'sports_field' and deviance > 5", event.choose_one('sports_field'))
        $ event("sports_field11", "act == 'sports_field' and inhibition > 95", event.choose_one('sports_field'))
        $ event("sports_field12", "act == 'sports_field' and athletics < 50", event.choose_one('sports_field'))
        $ event("sports_field13", "act == 'sports_field' and deviance > 55 and behavior < 45", event.choose_one('sports_field'))
        $ event("sports_field14", "act == 'sports_field' and athletics > 20", event.choose_one('sports_field'))
        $ event("sports_field15", "act == 'sports_field' and behavior > 35", event.choose_one('sports_field'))
        $ event("sports_field16", "act == 'sports_field' and (athletics < 45 or behavior < 45)", event.choose_one('sports_field'))
        $ event("sports_field17", "act == 'sports_field' and athletics < 50 and behavior < 50 and deviance > 5", event.choose_one('sports_field'))
        $ event("sports_field18", "act == 'sports_field' and athletics > 45", event.choose_one('sports_field'))
        $ event("sports_field19", "act == 'sports_field' and deviance > 20 and inhibition < 90", event.choose_one('sports_field'))
        $ event("sports_field20", "act == 'sports_field' and (inhibition < 50 or uniform == 'nude_uniform')", event.choose_one('sports_field'))
        $ event("sports_field21", "act == 'sports_field' and deviance > 5", event.choose_one('sports_field'))
        $ event("sports_field22", "act == 'sports_field' and inhibition < 90", event.choose_one('sports_field'))
        $ event("sports_field23", "act == 'sports_field' and athletics > 40", event.choose_one('sports_field'))
        $ event("sports_field24", "act == 'sports_field' and athletics > 55", event.choose_one('sports_field'))
        $ event("sports_field25", "act == 'sports_field' and inhibition < 100", event.choose_one('sports_field'))
        $ event("sports_field26", "act == 'sports_field' and inhibition > 70", event.choose_one('sports_field'))
        $ event("sports_field27", "act == 'sports_field' and inhibition < 90 and athletics > 50", event.choose_one('sports_field'))
        $ event("sports_field28", "act == 'sports_field' and athletics < 50", event.choose_one('sports_field'))
        $ event("sports_field29", "act == 'sports_field' and athletics > 50", event.choose_one('sports_field'))
        $ event("sports_field30", "act == 'sports_field' and athletics > 40 and inhibition < 95", event.choose_one('sports_field'))
        $ event("sports_field31", "act == 'sports_field' and athletics > 45 and inhibition < 100 and inhibition > 75", event.choose_one('sports_field'))
        $ event("sports_field32", "act == 'sports_field' and inhibition < 100 and inhibition > 75", event.choose_one('sports_field'))
        $ event("sports_field33", "act == 'sports_field' and inhibition > 20", event.choose_one('sports_field'))
        $ event("sports_field34", "act == 'sports_field' and morale > 75 and inhibition > 50", event.choose_one('sports_field'))
        $ event("sports_field35", "act == 'sports_field' and athletics > 50", event.choose_one('sports_field'))
        $ event("sports_field36", "act == 'sports_field' and athletics > 50", event.choose_one('sports_field'))
        $ event("sports_field37", "act == 'sports_field' and athletics > 75", event.choose_one('sports_field'))
        $ event("sports_field38", "act == 'sports_field' and athletics > 75 and inhibition < 75", event.choose_one('sports_field'))

label sports_field1:
    scene sports_field1 with fade
...
label sports_field4:
    scene sports_field4-1 with fade
...
label sports_field10:
    scene sports_field10 with fade
    girl "Oh!"
    menu:
        "Are you alright?":
...
label sports_field11:
    scene sports_field11 with fade
...
label sports_field12:
    ...
    $ renpy.show("sports_field12_"+randImg)
    with fade
...
label sports_field14:
    $ randImg = renpy.random.choice(["1", "2"])
    $ renpy.show("sports_field14_"+randImg)
    with fade
...
label sports_field15:
    scene sports_field15 with fade
...
label sports_field16:
    scene sports_field16 with fade
...
label sports_field17:
    scene sports_field17 with fade
    if (inhibition - deviance) < 50:
        "Somehow this poor girl got herself into a mess, and at the same time she shows off almost everything. A good view indeed."
    else:
        "This poor girl got herself into a mess, some how getting stuck in a net while showing off almost everything."
    if renpy.random.randint(1,3) == 1:
        "You decide to give her a hand and help her out."
        if deviance < 15:
            girl "*blush* Thanks [povTitle] [povLastName]."
            $ morale += 1
        else:
            girl "Aww, don't you like your girls tied up?"
...
label sports_field18:
    $ randImg = renpy.random.choice(["1", "2"])
    $ renpy.show("sports_field18_"+randImg)
    with fade
    if renpy.random.randint(1,3) == 1:
...
label sports_field19:
    scene sports_field19 with fade
    if renpy.random.randint(1,3) == 1:
...
label sports_field20:
    scene sports_field20 with fade
...
label sports_field21:
    scene sports_field21 with fade
...
label sports_field24:
    scene sports_field24 with fade
...
label sports_field25:
    scene sports_field25-1 with fade
...
label sports_field27:
    scene sports_field27 with fade
...
label sports_field28:
    scene sports_field28 with fade
    if renpy.random.randint(1,2) == 1:
...
label sports_field30:
    scene sports_field30 with fade
    if renpy.random.randint(1,2) == 1:
...
label sports_field31:
    scene sports_field31 with fade
    if renpy.random.randint(1,2) == 1:
...
label sports_field32:
    scene sports_field32 with fade
    if renpy.random.randint(1,2) == 1:
...
label sports_field33:
    if athletics > 45:
        scene sports_field33-1 with fade
        if renpy.random.randint(1,2) == 1:
...
label sports_field35:
    scene sports_field35-1 with fade
    girl "Ahh!"
    "It's wonderful to see a student giving her all."
    if evil_points > 1:
        "Maybe I should give her a hand..."
        menu:
            "Cop a feel":
                scene sports_field35-2
                if inhibition > 75:
                    girl "Ah!"
...
label sports_field36:
    if renpy.random.randint(1,2) == 1:
        scene sports_field36-1 with fade
    else:
        scene sports_field36-2 with fade
    if renpy.random.randint(1,2) == 1:
        "Its important to stretch both before and after training!"
    else:
        "Agility is just as important as strength and intelligence!"
    return


label sports_field37:

    if renpy.random.randint(1,2) == 1:
        scene sports_field37-1 with fade
    else:
        scene sports_field37-2 with fade
    if renpy.random.randint(1,2) == 1:
        "captain" "Keep it together girl!\nKeep on pushing, you can do it!"
    else:
        pov "...great work! New personal best!\nOne more lap, keep on running!"
    return


label sports_field38:
    if renpy.random.randint(1,2) == 1:
        scene sports_field38-1 with fade
    else:
        scene sports_field38-2 with fade
    if renpy.random.randint(1,2) == 1:
        girl "Ahahaha! I win again!"
    else:
        "Girls skipping around in short skirts hitting balls with all their power."
    return


label sports_field39:
    scene sports_field39-1 with fade
    girl "*pant* *pant* Ah.. How, how did I do?"
    if renpy.random.randint(1,2) == 1:
        "Coach" "Great! You got a new personal best!"
        scene sports_field39-2
        girl "Yeah!\n *giggle* I'm the best!"
    else:
        "Coach" "You did great, you're geeting real close to beating your personal best."
        girl "I better keep training then!"
    return
