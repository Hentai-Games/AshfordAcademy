init:
    if persistent.mod_disable_original_events == False:
        $ event("school_grounds1", "act == 'school_grounds' and morale > 25", event.choose_one('school_grounds'))
        $ event("school_grounds2", "act == 'school_grounds'", event.choose_one('school_grounds'))
        $ event("school_grounds3", "act == 'school_grounds' and deviance > 10", event.choose_one('school_grounds'))
        $ event("school_grounds4", "act == 'school_grounds'", event.choose_one('school_grounds'))
        $ event("school_grounds5", "act == 'school_grounds' and morale <= 5", event.choose_one('school_grounds'))
        $ event("school_grounds6", "act == 'school_grounds' and morale > 25", event.choose_one('school_grounds'))
        $ event("school_grounds7", "act == 'school_grounds'", event.choose_one('school_grounds'))
        $ event("school_grounds8", "act == 'school_grounds' and inhibition < 90", event.choose_one('school_grounds'))
        $ event("school_grounds9", "act == 'school_grounds' and morale > 15", event.choose_one('school_grounds'))
        $ event("school_grounds10", "act == 'school_grounds' and inhibition < 85 and deviance > 10", event.choose_one('school_grounds'))
        $ event("school_grounds11", "act == 'school_grounds' and morale > 25 and behavior > 25",  event.once(), event.choose_one('school_grounds'))
        $ event("school_grounds12", "act == 'school_grounds' and inhibition < 90", event.choose_one('school_grounds'))
        $ event("school_grounds13", "act == 'school_grounds' and inhibition < 90", event.choose_one('school_grounds'))
        $ event("school_grounds14", "act == 'school_grounds' and behavior < 25 and deviance > 0", event.choose_one('school_grounds'))
        $ event("school_grounds15", "act == 'school_grounds' and morale > 25", event.choose_one('school_grounds'))
        $ event("school_grounds16", "act == 'school_grounds' and behavior < 15", event.choose_one('school_grounds'))
        $ event("school_grounds17", "act == 'school_grounds' and inhibition > 85", event.choose_one('school_grounds'))
        $ event("school_grounds18", "act == 'school_grounds' and day > 15", event.choose_one('school_grounds'))
        $ event("school_grounds19", "act == 'school_grounds' and inhibition < 100", event.choose_one('school_grounds'))
        $ event("school_grounds20", "act == 'school_grounds' and academics < 40", event.choose_one('school_grounds'))
        $ event("school_grounds21", "act == 'school_grounds' and morale < 45 and behavior > 22", event.choose_one('school_grounds'))
        $ event("school_grounds22", "act == 'school_grounds' and morale < 35", event.choose_one('school_grounds'))
        $ event("school_grounds23", "act == 'school_grounds' and deviance > 15 and inhibition > 10", event.choose_one('school_grounds'))
        $ event("school_grounds24", "act == 'school_grounds' and morale > 35", event.choose_one('school_grounds'))
        $ event("school_grounds25", "act == 'school_grounds' and morale > 40 and inhibition < 95", event.choose_one('school_grounds'))
        $ event("school_grounds26", "act == 'school_grounds' and deviance > 25 and inhibition < 75 and new_game_plus == True", event.once(), event.choose_one('school_grounds', 5))     #WD: Stop Dup Events# priority=20)
        $ event("school_grounds27", "act == 'school_grounds' and deviance > 15 and inhibition < 75", event.choose_one('school_grounds'))                                                #Ash: Sorry sorry, I won't!
        $ event("school_grounds28", "act == 'school_grounds' and deviance > 35 and inhibition < 60", event.choose_one('school_grounds'))
        $ event("school_grounds29", "act == 'school_grounds' and inhibition > 80", event.choose_one('school_grounds'))
        $ event("school_grounds30", "act == 'school_grounds' and deviance > 50 and inhibition < 30", event.choose_one('school_grounds'))
        $ event("school_grounds31", "act == 'school_grounds' and inhibition > 85", event.choose_one('school_grounds'))
        $ event("school_grounds32", "act == 'school_grounds' and day < 15", event.choose_one('school_grounds'))
        $ event("school_grounds33", "act == 'school_grounds' and morale  < 45", event.choose_one('school_grounds'))
        $ event("school_grounds34", "act == 'school_grounds' and behavior < 75", event.choose_one('school_grounds'))
        $ event("school_grounds35", "act == 'school_grounds' and inhibition < 75", event.choose_one('school_grounds'))
        $ event("school_grounds36", "act == 'school_grounds' and morale > 60", event.choose_one('school_grounds'))
        $ event("school_grounds37", "act == 'school_grounds' and inhibition > 75 and morale > 40", event.choose_one('school_grounds'))
        $ event("school_grounds38", "act == 'school_grounds' and morale > 30", event.choose_one('school_grounds'))
        $ event("school_grounds39", "act == 'school_grounds' and pda_rule_level < 3 and inhibition < 100", event.choose_one('school_grounds'))
        $ event("school_grounds40", "act == 'school_grounds' and morale > 50", event.choose_one('school_grounds'))
        $ event("school_grounds41", "act == 'school_grounds' and behavior > 50", event.choose_one('school_grounds'))
        $ event("school_grounds42", "act == 'school_grounds' and morale < 50", event.choose_one('school_grounds'))
        $ event("school_grounds43", "act == 'school_grounds' and reputation > 90", event.choose_one('school_grounds'))
        $ event("school_grounds44", "act == 'school_grounds' and reputation > 25 and morale > 30", event.choose_one('school_grounds'))
        $ event("school_grounds45", "act == 'school_grounds' and morale > 40 and behavior > 40", event.choose_one('school_grounds'))
        $ event("school_grounds46", "act == 'school_grounds' and morale > 40", event.choose_one('school_grounds'))
        $ event("school_grounds47", "act == 'school_grounds' and inhibition > 75 and inhibition < 95", event.choose_one('school_grounds'))
        $ event("school_grounds48", "act == 'school_grounds' and inhibition < 85 and uniform == ('sexy_uniform' or 'nude_uniform')", event.choose_one('school_grounds'))
        $ event("school_grounds49", "act == 'school_grounds' and inhibition > 70 and inhibition < 95", event.choose_one('school_grounds'))

label school_grounds1:
    $ randImg = renpy.random.choice(["1", "2"])
    $ renpy.show("school_grounds1_"+randImg)
    with fade
...
label school_grounds2:
    $ randImg = renpy.random.choice(["1", "2"])
    $ renpy.show("school_grounds2_"+randImg)
    with fade
...
label school_grounds3:
    ...
    scene school_grounds3 with fade
...
label school_grounds4:
    ...
    scene school_grounds4 with fade
...
label school_grounds5:
    ...
    scene school_grounds5-1 with fade
    "You see a sad looking girl sitting against the wall."

    menu:
        "Talk to her":
            scene school_grounds5-2 with fade
...
label school_grounds6:
    ...
    scene school_grounds6 with fade
...
label school_grounds7:
    ...
    scene school_grounds7 with fade
...
label school_grounds8:
    ...
    scene school_grounds8 with fade
...
label school_grounds9:
    ...
    scene school_grounds9 with fade
...
label school_grounds10:
    ...
    scene school_grounds10 with fade
...
label school_grounds11:
    ...
    scene school_grounds11 with fade
...
label school_grounds13:
    ...
    scene school_grounds13 with fade
...
label school_grounds14:
    ...
    scene school_grounds14 with fade
...
label school_grounds15:
    ...
    scene school_grounds15 with fade
...
label school_grounds16:
    ...
    scene school_grounds16 with fade
...
label school_grounds17:
    ...
    scene school_grounds17 with fade
...
label school_grounds18:
    ...
    scene school_grounds18 with fade
...
label school_grounds19:
    ...
    scene school_grounds19 with fade
...
label school_grounds20:
    ...
    scene school_grounds20 with fade
    girl "Whoa!"
    pov "What is it?"
...
label school_grounds21:
    ...
    scene school_grounds21 with fade
...
label school_grounds22:
    if renpy.random.randint(1,1) == 1:
        scene school_grounds22-1 with fade
    else:
        scene school_grounds22-2 with fade
...
label school_grounds24:
    ...
    scene school_grounds24 with fade
...
label school_grounds25:
    $ randImg = renpy.random.choice(["1", "2"])
    $ renpy.show("school_grounds25_"+randImg)
    with fade
...
label school_grounds26:
    ...
    scene school_grounds26-1 with fade
...
label school_grounds29:
    $ randImg = renpy.random.choice(["1", "2"])
    $ renpy.show("school_grounds29_"+randImg)
    with fade
...
label school_grounds30:
    ...
    scene school_grounds30 with fade
...
label school_grounds31:
    ...
    scene school_grounds31 with fade
...
label school_grounds32:
    ...
    scene school_grounds32 with fade
    if renpy.random.randint(1,1) == 1:
...
label school_grounds33:
    ...
    scene school_grounds33 with fade
...
label school_grounds34:
    ...
    scene school_grounds34 with fade
...
label school_grounds35:
    ...
    scene school_grounds35 with fade
...
label school_grounds36:
    ...
    scene school_grounds36 with fade
...
label school_grounds37:
    ...
    scene school_grounds37 with fade
    if renpy.random.randint(1,2) == 1:
...
label school_grounds38:
    ...
    scene school_grounds38-1 with fade
...
label school_grounds39:
    ...
    scene school_grounds39 with fade
...
label school_grounds40:
    ...
    $ randImg = renpy.random.choice(["1", "2"])
    $ renpy.show("school_grounds40_"+randImg)
    with fade
...
label school_grounds41:
    ...
    scene school_grounds41-1 with fade
...
label school_grounds42:
    ...
    scene school_grounds42 with fade
...
label school_grounds43:
    ...
    scene school_grounds43 with fade
...
label school_grounds44:
    ...
    scene school_grounds44 with fade
...
label school_grounds45:
    $ randImg = renpy.random.choice(["1", "2"])
    $ renpy.show("school_grounds45_"+randImg)
    with fade
...
label school_grounds46:
    ...
    scene school_grounds46 with fade
...
label school_grounds49:
    $ randImg = renpy.random.choice(["1", "2"])
    $ renpy.show("school_grounds49_"+randImg)
    with fade
