...
init:
    ...
    $ event("class_introduction", "act == 'class'", event.once(), event.only(), priority=1)

    if persistent.mod_disable_original_events == False:
        $ event("class1", "act == 'class' and deviance < 20", event.choose_one('class'))
        $ event("class2", "act == 'class' and behavior < 50", event.choose_one('class'))
        $ event("class3", "act == 'class' and deviance <= 15", event.choose_one('class'))
        $ event("class4", "act == 'class' and deviance >= 50 and pda_rule_level >= 5", event.choose_one('class'))
        $ event("class5", "act == 'class' and behavior <= 10", event.choose_one('class'))
        $ event("class6", "act == 'class' and inhibition > 40", event.choose_one('class'))
        $ event("class7", "act == 'class' and inhibition <= 85 and deviance >= 10", event.choose_one('class'))
        $ event("class8", "act == 'class' and inhibition <= 70 and deviance >= 65 and behavior < 75", event.once(), event.only(), priority=20)
        $ event("class9", "act == 'class' and inhibition <= 95 and deviance >= 10 and inhibition > 50", event.choose_one('class'))
        $ event("class10", "act == 'class' and inhibition < 90 and inhibition > 60", event.choose_one('class'))
        $ event("class11", "act == 'class' and inhibition > 50 and pda_rule_level <= 2", event.choose_one('class'))
        $ event("class12", "act == 'class' and academics > 35", event.choose_one('class'))
        $ event("class13", "act == 'class' and inhibition <= 85 and deviance >= 10", event.choose_one('class'))
        $ event("class14", "act == 'class' and inhibition < 65 and deviance > 50", event.choose_one('class'))
        $ event("class15", "act == 'class' and day > 25 and deviance > 15 and inhibition > 40", event.choose_one('class'))
        $ event("class16", "act == 'class' and inhibition <= 80 and deviance >= 15", event.choose_one('class'))
        $ event("class17", "act == 'class' and inhibition <= 85 and morale >= 25", event.choose_one('class'))
        $ event("class18", "act == 'class' and behavior >= 25", event.choose_one('class'))
        $ event("class19", "act == 'class' and inhibition <= 85 and behavior <= 20", event.choose_one('class'))
        $ event("class20", "act == 'class' and inhibition <= 85 and academics <= 40", event.choose_one('class'))
        $ event("class21", "act == 'class' and deviance > 5 and behavior < 35", event.choose_one('class'))
        $ event("class22", "act == 'class' and deviance > 0 and inhibition < 100", event.choose_one('class'))
        $ event("class23", "act == 'class' and deviance > 50 and inhibition < 50", event.choose_one('class'))
        $ event("class24", "act == 'class' and inhibition < 100 and deviance > 5", event.choose_one('class'))
        $ event("class25", "act == 'class' and inhibition < 85 and deviance > 10", event.choose_one('class'))
        $ event("class26", "act == 'class' and inhibition < 75 and deviance > 25 and behavior < 45", event.choose_one('class'))
        $ event("class27", "act == 'class' and learning_materials == 0.7 and inhibition < 90 and academics > 45", event.once(), event.only(), priority=20)
        $ event("class28", "act == 'class' and inhibition < 90 and deviance > 10", event.choose_one('class'))
        $ event("class29", "act == 'class' and inhibition < 85 and deviance > 10", event.choose_one('class'))
        $ event("class30", "act == 'class' and behavior < 45 and morale < 45 and month > 1", event.once(), event.only(), priority=20)
        $ event("class31", "act == 'class' and morale > 50 and behavior > 35", event.choose_one('class'))
        $ event("class32", "act == 'class' and morale > 50 and behavior > 35", event.choose_one('class'))
        $ event("class33", "act == 'class' and inhibition < 85 and deviance > 10", event.choose_one('class'))
        $ event("class34", "act == 'class' and inhibition < 75 and deviance > 20 and pda_rule_level >= 5", event.choose_one('class'))
        ...
        $ event("class43", "act == 'class' and deviance <= 40 and inhibition < 95", event.choose_one('class'))
        $ event("class44", "act == 'class' and academics > 35", event.choose_one('class'))
        $ event("class45", "act == 'class' and academics < 50", event.choose_one('class'))
        $ event("class46", "act == 'class' and morale > 35 and academics > 35", event.choose_one('class'))
        $ event("class47", "act == 'class' and morale > 40 and reputation < 15", event.choose_one('class'))
        $ event("class48", "act == 'class' and morale > 35 and academics > 35", event.choose_one('class'))
        $ event("class49", "act == 'class' and inhibition > 75", event.choose_one('class'))
        $ event("class50", "act == 'class' and reputation > 15", event.choose_one('class'))
        $ event("class51", "act == 'class' and inhibition < 85", event.choose_one('class'))
        $ event("class52", "act == 'class' and building_cafeteria > 0", event.choose_one('class'))
        $ event("class53", "act == 'class' and building_classrooms > 3", event.choose_one('class'))

        #$ event("class99", "act == 'class' and inhibition < 70 and deviance > 25 and good_points > 0", event.once(), event.choose_one('class', 5))     #WD: Stop Dup Events# priority=20)
                                                                                                                                                        #Ash: ... I already said sorry, yes and I promise...
    ...
    menu:
        "I know what you want." if deviance > 25:
            menu:
                ...
                "Degrade her in front of her class." if pda_rule_level >= 5 or behavior_rules == 'behavior_no_limit':
