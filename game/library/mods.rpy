...
############################
    ...
    if not persistent.mod_custom_title_screen:
        persistent.mod_custom_title_screen_ground = "images/ui/mm_ground.png"
        persistent.mod_custom_title_screen_idle = "images/ui/mm_idle.png"
        persistent.mod_custom_title_screen_hoover = "images/ui/mm_hover.png"
    ...
    mod_list = [] # this is the initial mods list, most likely empty.
...
screen mod_manager:
    ...
    hbox:
        ...
        if persistent.new_game_plus == True:
            text"Notice: Usage of the mod manager and external mods might break your heart."
        else:
            text"Notice: Usage of the mod manager and external mods might break your game."
        spacing 390
        textbutton _("Return") action Return()

# mods list screen (for debug/ingame)
