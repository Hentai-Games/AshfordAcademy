...
image ach_acquired = "images/ui/achievement_acquired.png"
image ach_not_acquired = "images/ui/achievement_not_acquired.png"
...
init:
    ...
    # $ event("example_achievement", "morale >= 0 and example_achievement_trigger == False", event.solo(), priority=-90)

    ## Stat related
    $ event("perfect_students_achievement", "behavior == 100 and academics == 100 and artistery == 100 and athletics == 100 and persistent.perfect_students_achievement_trigger != True", event.solo(), priority=-90)
    $ event("behave_and_be_happy_achievement", "behavior == 100 and morale == 100 and persistent.behave_and_be_happy_achievement_trigger != True", event.solo(), priority=-90)
    $ event("ein_zwei_einstein_achievement", "academics == 100 and persistent.ein_zwei_einstein_achievement_trigger  != True", event.solo(), priority=-90)
    $ event("monet_madness_achievement", "artistery == 100 and persistent.monet_madness_achievement_trigger != True", event.solo(), priority=-90)
    $ event("pumping_iron_achievement", "athletics == 100 and persistent.pumping_iron_achievement_trigger != True", event.solo(), priority=-90)
    $ event("the_1_achievement", "cash >= 25000 and persistent.the_1_achievement_trigger != True", event.solo(), priority=-90)
    $ event("hentai_highschool_achievement", "deviance == 100 and inhibition == 0 and persistent.hentai_highschool_achievement_trigger != True", event.solo(), priority=-90)
    $ event("take_that_mit_achievement", "reputation >= 100 and persistent.take_that_mit_achievement_trigger != True", event.solo(), priority=-90)
                ...
                grid 3 11:
                    ...
                    vbox:
                        if persistent.perfect_students_achievement_trigger == True:
                            image("images/ui/achievement_acquired.png")
                        else:
                            image("images/ui/achievement_not_acquired.png")
                    vbox:
                        ypos 20
