init:
    ...
    if persistent.mod_disable_original_events == False:
        ...
        $ event("dormitory2", "act == 'dormitory'", event.choose_one('dormitory'))
        ...
        $ event("dormitory9", "act == 'dormitory' and new_game_plus == True", event.choose_one('dormitory'))
        ...
        $ event("dormitory22", "act == 'dormitory'", event.choose_one('dormitory'), priority=200)
        #$ event("dormitory23", "act == 'dormitory'", event.choose_one('dormitory'), priority=200)
        $ event("dormitory24", "act == 'dormitory'", event.choose_one('dormitory'), priority=200)
        $ event("dormitory25", "act == 'dormitory'", event.choose_one('dormitory'), priority=200)
        $ event("dormitory26", "act == 'dormitory' and inhibition < 95 and deviance > 5", event.choose_one('dormitory'))
        $ event("dormitory27", "act == 'dormitory'", event.choose_one('dormitory'), priority=200)
        $ event("dormitory28", "act == 'dormitory' and academics > 40", event.choose_one('dormitory'), priority=200)
