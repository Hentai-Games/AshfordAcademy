image sports_tourney1 = "locations/special_events/sports_tourney1.jpg"         # Win
image sports_tourney2 = "locations/special_events/sports_tourney2.jpg"         # Loss
image sports_tourney3 = "locations/special_events/sports_tourney3.jpg"         # Win
image sports_tourney4 = "locations/special_events/sports_tourney4.jpg"         # Great victory
image sports_tourney5 = "locations/special_events/sports_tourney5.jpg"         # Bad loss

image fitness_training1 = "locations/special_events/fitness_training1.jpg"
#image fitness_training2 = "locations/special_events/fitness_training2.jpg"
#image fitness_training3 = "locations/special_events/fitness_training3.jpg"
#image fitness_training4 = "locations/special_events/fitness_training4.jpg"
#image fitness_training5 = "locations/special_events/fitness_training5.jpg"

image standard_test1 = "locations/special_events/standard_test1.jpg"

image art_exhibit1 = "locations/special_events/art_exhibit1.jpg"

image school_trip1 = "locations/special_events/school_trip1.jpg"
image school_trip2 = "locations/special_events/school_trip2.jpg"
image school_trip3 = "locations/special_events/school_trip3.jpg"
image school_trip4 = "locations/special_events/school_trip4.jpg"
image school_trip5 = "locations/special_events/school_trip5.jpg"
image school_trip6 = "locations/special_events/school_trip6.jpg"

# Raise money options
image raise_money clean_the_streets = "locations/special_events/raise_money_clean_the_streets.jpg"
...
init python:
    ...
    def monthly_goal_check():
        ...
        elif globals()['monthly_goal_type'] == "skip":
            return True
    ...
    def monthly_goal_menu():
        ...
        if not skip_building_goal and not skip_stat_goal:
            ...
            globals()['monthly_goal_type'] = "skip"
            return
        ...
        if goal == "goal_building":
            ...
            goal_difficulty3 = int(eval(goal_stat) + 10 + (5 * 3))
            goal_difficulty2 = int(eval(goal_stat) + 10 + (5 * 2))
            goal_difficulty1 = int(eval(goal_stat) + 10 + (5 * 1))
...
label weekly_planning:
    ...
    if first_week == True:
        ...
        $ called_in_sick = renpy.random.randint(0, (population - behavior)/20)
        $ renpy.show(lia_outfit+"_lia smile")
        if called_in_sick > 0:
            if lia_points < 5:
                lia "Hello principal.\nThis week [called_in_sick] students have called in sick."
            elif lia_points < 10 and lia_points > 5:
                lia "Hello [povTitle] [povLastName].\nThis week [called_in_sick] students have called in sick."
            else:
    ...
    if first_week == True:
        ...
        python:
            if min(academics, artistery, athletics) < 20 + month:
...
label monthly_planning:
    ...
    scene office with fade
    if renpy.random.randint(1, 3) == 1:
        pov "And this months paperwork is done."
    elif renpy.random.randint(1, 2) == 1:
        pov "Always additional work needed to be done..."
    else:
        pov "A job well done."
