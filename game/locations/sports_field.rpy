init:
    if persistent.mod_disable_original_events == False:
        $ event("sports_field1", "act == 'sports_field' and deviance < 5", event.choose_one('sports_field'))
        $ event("sports_field2", "act == 'sports_field' and deviance < 5 and athletics < 25", event.choose_one('sports_field'))
        $ event("sports_field3", "act == 'sports_field' and deviance < 5", event.choose_one('sports_field'))
        ...
        $ event("sports_field7", "act == 'sports_field' and deviance > 5", event.choose_one('sports_field'))
