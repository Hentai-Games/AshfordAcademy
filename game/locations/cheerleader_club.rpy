init:
    if persistent.mod_disable_original_events == False:
        $ event("cheerleader_club1", "act == 'cheerleader_club'", event.choose_one('cheerleader_club'))
        $ event("cheerleader_club2", "act == 'cheerleader_club'", event.choose_one('cheerleader_club'))
        $ event("cheerleader_club3", "act == 'cheerleader_club'", event.choose_one('cheerleader_club'))
        
        #TODO: Actually add events!
        $ event("cheerleader_club4", "act == 'cheerleader_club'", event.choose_one('cheerleader_club'))
        $ event("cheerleader_club5", "act == 'cheerleader_club'", event.choose_one('cheerleader_club'))
        $ event("cheerleader_club6", "act == 'cheerleader_club'", event.choose_one('cheerleader_club'), event.depends("cheerleader_club5"))
