...
label new_game_story:
    ...
    scene Ashford_Academy with fade
...
label interrogation:
    ...
    scene police_station_interrogation with fade
            ...
            menu:
                "By the sound of it, you completely rule out that it might have been an accident?":
                    ...
                    menu:
                        ...
                        "We're all lucky to have you on the job then.":
